<template>
	<div id="app">
		...
		<p v-destaque-local:fundo.atrasar.alternar="{cor1:'green', cor2:'aquamarine', atraso:2000, intervalo:200}">Usando diretiva personalizada </p>
		<p v-destaque-local.atrasar="{cor1:'purple', atraso:5000}">Usando diretiva personalizada </p>
	</div>
</template>
